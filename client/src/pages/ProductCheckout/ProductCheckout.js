...
class ProductCheckout extends Component {
    ...
    componentDidMount () {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}/api/product/viewproduct/${this.state.productId}`)
             .then(res => {
    ...
    onSubmitHandler = (e) => {
        e.preventDefault()
        axios.post(`${process.env.REACT_APP_API_URL}/api/bid/addbidder/${this.state.productId}`, {bidPrice: this.state.bidPrice, id: this.props.user._id})
            .then(res => {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-4" id="pc__card">
                        <div className="card p-5">
                            <img
                                ...
                                src={`${process.env.REACT_APP_API_URL}/api/product/image/${this.state.product.imageId}`} />
                    ...
                    <form className="mt-5">
                        ...
                        <StripeCheckoutButton price={this.state.bidPrice} productId={this.state.productId} userId={this.props.user._id}/>
                    </div>
                </div>
            </div>
        )
